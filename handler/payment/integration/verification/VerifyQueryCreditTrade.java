package handler.payment.integration.verification;

import handler.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import handler.payment.integration.ecpayOperator.PaymentVerifyBase;
...
public class VerifyQueryCreditTrade extends PaymentVerifyBase {
    ...
    public String getAPIUrl(String mode) {
        Element ele = (Element) this.doc.getElementsByTagName("QueryCreditCardPeriodInfo").item(0);
        String url = "";
